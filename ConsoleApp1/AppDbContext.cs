...
namespace ConsoleApp1
{
    public class AppDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, long>
    {
        ...
        {
            optionsBuilder.UseSqlServer("data source=.;initial catalog=LetsTravel;integrated security=True;application name=LetsTravel App;Pooling=true;Min Pool Size=5;Max Pool Size=30;");
        }
    }
}
